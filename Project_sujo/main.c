...
int RenderHelp() {
	...
	printf("\n");
	printf("\n");
	printf("《30살까지 모솔이면 마법사가 된다는 소문이 사실인 것 같습니다》\n");
	printf("\n");
	printf("이 게임은 뭔가요?\n");
	printf("\n");
	...
	printf("단 한 번이라도 잘못된 선택지를 선택한 순간 다시 처음으로 돌아가게 됩니다.\n");
	printf("\n");
	printf("3. 최종 목표\n");
	printf("\n");
	printf("반복되는 루프 속에서 진정한 히로인 공략에 성공하여 Loop를 끝내세요.\n");
	printf("\n");
	printf("\n");
	printf("플레이 팁\n");
	printf("\n");
	printf("관찰하세요.\n");
	printf("히로인의 반응을 보면 힌트가 있습니다. 대사 한 줄도 허투루 읽지 마세요.\n");
	printf("\n");
	printf("무리하지 마세요.\n");
	printf("억지스러운 멘트나 지나친 적극성은 대부분 배드엔딩으로 직결됩니다.\n");
	printf("자연스러운 쪽이 정답인 경우가 많습니다.\n");
	printf("\n");
	printf("고백은 타이밍입니다.\n");
	printf("분위기를 만들어놓고 우물쭈물하면 루프는 하루 더 늘어납니다.\n");
	return 0;
}
